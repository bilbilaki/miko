...
import 'package:miko/box/data/store/config.dart';
import 'package:miko/box/data/store/history.dart';
import 'package:miko/box/data/store/setting.dart';
import 'package:miko/box/data/store/tool.dart';
import 'package:miko/box/data/store/trash.dart';
...
abstract final class Stores {
  ...
  static final List<HiveStore> all = [setting, history, config, mcp, trash];
