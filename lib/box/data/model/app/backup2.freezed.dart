...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int version,  int date,  Map<String, Object?> cfgs,  Map<String, Object?> tools,  Map<String, Object?> histories,  Map<String, Object?> trashes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BackupV2() when $default != null:
return $default(_that.version,_that.date,_that.cfgs,_that.tools,_that.histories,_that.trashes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int version,  int date,  Map<String, Object?> cfgs,  Map<String, Object?> tools,  Map<String, Object?> histories,  Map<String, Object?> trashes)  $default,) {final _that = this;
switch (_that) {
case _BackupV2():
return $default(_that.version,_that.date,_that.cfgs,_that.tools,_that.histories,_that.trashes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int version,  int date,  Map<String, Object?> cfgs,  Map<String, Object?> tools,  Map<String, Object?> histories,  Map<String, Object?> trashes)?  $default,) {final _that = this;
switch (_that) {
case _BackupV2() when $default != null:
return $default(_that.version,_that.date,_that.cfgs,_that.tools,_that.histories,_that.trashes);case _:
  return null;
