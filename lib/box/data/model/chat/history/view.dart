...
import 'package:miko/box/view/widget/code.dart';
...
final class ChatRoleTitle extends StatelessWidget {
  ...
  const ChatRoleTitle({required this.role, required this.loading, super.key});
...
final class ChatHistoryContentView extends StatelessWidget {
  ...
  const ChatHistoryContentView({required this.chatItem, super.key});
