...
class AnimeEpisodeDetailPage extends StatefulWidget {
  ...
  @override
  State<AnimeEpisodeDetailPage> createState() => _AnimeEpisodeDetailPageState();
}

class _AnimeEpisodeDetailPageState extends State<AnimeEpisodeDetailPage> {
  late Future<EpisodeDetails> _episodeDetailsFuture;
  AnimeProvider seriesProvider = AnimeProvider();
