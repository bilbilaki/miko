...
import 'package:miko/showcases/tvepisodedetailpage.dart';
import 'model.dart';
import 'movie_service.dart';

class SeasonDetailPageTV extends StatefulWidget {
  final int tvShowId;
  ...
  @override
  State<SeasonDetailPageTV> createState() => _SeasonDetailPageTVState();
}

class _SeasonDetailPageTVState extends State<SeasonDetailPageTV> {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TVEpisodeDetailPage(
