...
class TvShowPage1 extends StatefulWidget {
  ...
  @override
  State<TvShowPage1> createState() => _TvShowPageState();
}

class _TvShowPageState extends State<TvShowPage1> {
  ...
  Future<void> _loadTvShows2() async {
    ...
    try {
      final response = await _movieService.getPopularTvShows(page: _currentPage2);
