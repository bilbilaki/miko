...
import '../showcases/model.dart' as TmdbApiMovieModel show Movie;

// =========================================================================
// == NEW UNIFIED MODEL - USE THIS THROUGHOUT YOUR APP
// =========================================================================

/// Use this enum to easily distinguish between media types in your UI.
enum MediaType { movie, tv }

/// A unified model to represent either a Movie or a TV Show.
/// This allows you to create lists and UI that can handle both types
/// without complex `if/else` checks for the object type.
class MediaItem {
  ...
  final DateTime? releaseDate; // 'releaseDate' for movies, 'firstAirDate' for TV
  final List<String> genres;
  final List<String> keywords;
  final String? rawVideos; // Common field for video data

  // --- TV-Specific Fields (nullable) ---
  ...
  static const String _backdropBaseUrl = 'https://inosdb.worker-inosuke.workers.dev/w780';
  ...
  // Private constructor that sets all the fields.
  MediaItem._({
    required this.id,
  ...
  // --- FACTORY CONSTRUCTORS TO CONVERT FROM SOURCE MODELS ---

  /// Creates a MediaItem from a Movie object.
  factory MediaItem.fromMovie(Movie movie) {
    return MediaItem._(
      ...
      rawVideos: movie.rawVideos,
      // Movie-specific fields
      rawDownloadLinks: movie.rawDownloadLinks,
      runtime: movie.runtime,
      tagline: movie.tagline,
      // TV-specific fields are null
      seasons: null,
  ...
  /// Creates a MediaItem from a TvSeriesAnime object.
  factory MediaItem.fromTvSeries(TvSeriesAnime series) {
    return MediaItem._(
      id: series.tmdbId, // Use tmdbId from series
      mediaType: MediaType.tv,
      title: series.name, // Use name from series
      ...
      releaseDate: series.firstAirDate, // Use firstAirDate from series
      genres: series.genres,
      keywords: series.keywords,
      rawVideos: series.rawVideos,
      // TV-specific fields
      seasons: series.seasons,
      numberOfSeasons: series.numberOfSeasons,
      numberOfEpisodes: series.numberOfEpisodes,
      // Movie-specific fields are null
      rawDownloadLinks: null,
      runtime: series.runtime, // Can also use series runtime (per episode)
      tagline: null,
    );
  }
}
...
// =========================================================================
// == EXISTING MODELS - NOW USED PRIMARILY FOR DATA LOADING
// =========================================================================
